...
export default [
    ...
    layout('routes/admin/admin-layout.tsx', [
        ...
        route('trip', 'routes/admin/trips.tsx'), // path: '/trips', file: 'routes/admin/trips.tsx'
        route('trip/create', 'routes/admin/createTrip.tsx'), // path: 'trips/create', file: 'routes/admin/createTrip.tsx'
